#!/usr/bin/env python3
"""Run a filtered Excel-DNA skill campaign with the local Claude Code CLI."""
...
def scenario_prompt(scenario: dict, skill_dir: Path, activation: str) -> str:
    ...
    if activation == "explicit":
        return f"""You are running an Excel-DNA skill evaluation scenario in Claude Code.

Use the repository guidance in CLAUDE.md and AGENTS.md.
